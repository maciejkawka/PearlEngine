...
namespace PrCore {
	...
	public:
		ResourceUnloadedEventv2(ResourceID p_id, const std::string& p_path) :
			m_id(p_id),
			m_path(p_path)
		{}
	...
	public:
		ResourceLoadedEventv2(ResourceID p_id, const std::string& p_path) :
			m_id(p_id),
			m_path(p_path)
		{}
	...
	public:
		ResourceCorruptedEventv2(ResourceID p_id, const std::string& p_path) :
			m_id(p_id),
			m_path(p_path)
		{}
	...
	public:
		CacheMissEventv2(ResourceID p_id, const std::string& p_path) :
			m_id(p_id),
			m_path(p_path)
		{}
	...
	public:
		BudgetExceededv2(ResourceID p_id, const std::string& p_path, size_t p_usage, size_t p_budget) :
			m_id(p_id),
			m_path(p_path),
			m_usage(p_usage),
			m_budget(p_budget)
