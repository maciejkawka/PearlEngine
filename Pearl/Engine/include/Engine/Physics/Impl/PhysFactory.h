...
namespace PrPhysics {
	...
	public:
		...
		IConvexMeshPtr       CreateConvexMesh(PrRenderer::Resources::MeshPtr p_mesh) override;
		IConvexMeshPtr       CreateConvexMesh(uint8_t* p_data, size_t p_size) override;
		ITriangleMeshPtr     CreateTriangleMesh(PrRenderer::Resources::MeshPtr p_mesh) override;
