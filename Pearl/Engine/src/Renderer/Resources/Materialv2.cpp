...
Materialv2::Materialv2(ShaderPtr p_shader)
{
	m_shader = p_shader;
...
Materialv2::Materialv2(const Materialv2& p_material)
{
...
const PrRenderer::Core::Color& Materialv2::GetColor() const
{
	auto find = m_uniforms.find(COLOR_UNIFORM);
...
void Materialv2::SetTexture(const std::string& p_name, TexturePtr p_texture)
{
...
TexturePtr Materialv2::GetTexture(const std::string& p_name)
{
	auto find = m_textures.find(p_name);
...
void Materialv2::SetTexScale(const std::string& p_name, const PrCore::Math::vec2& p_value)
{
...
void Materialv2::SetTexOffset(const std::string& p_name, const PrCore::Math::vec2& p_value)
{
...
PrCore::Math::vec2 Materialv2::GetTexScale(const std::string& p_name) const
{
	auto find = m_uniforms.find(p_name + TEXSCALE_UNIFORM);
...
PrCore::Math::vec2 Materialv2::GetTexOffset(const std::string& p_name) const
{
	auto find = m_uniforms.find(p_name + TEXOFFSET_UNIFORM);
...
bool Materialv2::HasProperty(const std::string& p_name) const
{
	return m_uniforms.find(p_name) != m_uniforms.end();
}

void Materialv2::CopyPropertiesFrom(const Materialv2& p_material)
{
	m_renderType = p_material.GetRenderType();
	m_renderOrder = p_material.GetRenderOrder();
	m_textures = p_material.m_textures;
...
bool Materialv2::PopulateBasedOnShader(JSON::json& p_json)
{
...
size_t Materialv2::GetByteSize() const
{
	return sizeof(Materialv2);
}
